...
export default function Footer() {
  return (
    <footer className="bg-white border-t-2 border-garay-100">
      <div className="mx-auto w-full max-w-screen-xl py-6 lg:py-8">
        ...
        <div className="flex items-center justify-between flex-col-reverse gap-4 sm:flex-row">
          ...
          <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
            <Link
              to="https://www.instagram.com/_trieaurora/"
            ...
            <Link to="#" className="text-black w-5 h-5 fill-current">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
                y="0px"
            ...
            <Link
              to="mailto:21120139@student.hcmus.edu.vn"
